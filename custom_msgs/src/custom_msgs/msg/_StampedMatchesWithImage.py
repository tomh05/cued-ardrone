"""autogenerated by genpy from custom_msgs/StampedMatchesWithImage.msg. Do not edit."""
import sys
...
class StampedMatchesWithImage(genpy.Message):
  _md5sum = "11315e55547abf288909d784e74e3315"
  _type = "custom_msgs/StampedMatchesWithImage"
...
"""
  __slots__ = ['header','pts','image']
  _slot_types = ['std_msgs/Header','float32[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StampedMatchesWithImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.pts))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pts = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
