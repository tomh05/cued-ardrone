"""autogenerated by genpy from custom_msgs/StampedFeaturesWithImage.msg. Do not edit."""
import sys
...
class StampedFeaturesWithImage(genpy.Message):
  _md5sum = "74a75521b3e424cb7c3eb77371581276"
  _type = "custom_msgs/StampedFeaturesWithImage"
...
"""
  __slots__ = ['header','points','descriptors','descriptors_stride','descriptors_matcher','image']
  _slot_types = ['std_msgs/Header','float32[]','float32[]','int16','string','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,points,descriptors,descriptors_stride,descriptors_matcher,image
    ...
    """
    if args or kwds:
      super(StampedFeaturesWithImage, self).__init__(*args, **kwds)
