"""autogenerated by genpy from custom_msgs/StampedStampedInt.msg. Do not edit."""
import sys
...
class StampedStampedInt(genpy.Message):
  _md5sum = "456f6e7b11f035fb268f51b6a451715b"
  _type = "custom_msgs/StampedStampedInt"
...
"""
  __slots__ = ['header1','header2','count']
  _slot_types = ['std_msgs/Header','std_msgs/Header','int16']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StampedStampedInt, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_h.pack(self.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.count,) = _struct_h.unpack(str[start:end])
      return self
