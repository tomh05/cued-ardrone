...
expected_zone_inner = [320,180,0,0]
expected_zone_outer = [0,0,640, 360]
fileno = 0
fpsavg = 0
prevtime = 0
time = 0
...
def process_frame(cimg):
    ...
    # too small
    sqrs2 = [s for s in sqrs2 if s[2] > 48 or s[3] > 48]
    ...
    if selected_square_temp != None:
        ...
        cv2.rectangle(cimg2, pt1, pt2, (0,255,255), 1)
        count+=1
        print 'writing ' + '/home/alex/bags/'+str(count)+'.jpg'
        cv2.imwrite('/home/alex/bags/'+str(count)+'.jpg', cimg2)
        ...
        grow_square(expected_zone_outer, 1.5)      
