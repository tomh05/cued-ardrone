...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CaptureImageFeatures-request>)))
  ...
  "b8ef2bae196753f15b0d0b9888ac4b4a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CaptureImageFeatures-request)))
  "Returns md5sum for a message object of type 'CaptureImageFeatures-request"
  "b8ef2bae196753f15b0d0b9888ac4b4a")
...
(cl:defmethod alt-val ((m <CaptureImageFeatures-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-srv:alt-val is deprecated.  Use dynamics-srv:alt instead.")
  (alt m))

(cl:ensure-generic-function 'img-val :lambda-list '(m))
(cl:defmethod img-val ((m <CaptureImageFeatures-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-srv:img-val is deprecated.  Use dynamics-srv:img instead.")
  (img m))
