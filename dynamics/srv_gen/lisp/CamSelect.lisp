...
(cl:defmethod cl:initialize-instance :after ((m <CamSelect-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamSelect-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamics-srv:<CamSelect-request> is deprecated: use dynamics-srv:CamSelect-request instead.")))

(cl:ensure-generic-function 'channel-val :lambda-list '(m))
(cl:defmethod channel-val ((m <CamSelect-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-srv:channel-val is deprecated.  Use dynamics-srv:channel instead.")
  (channel m))
...
(cl:defmethod cl:initialize-instance :after ((m <CamSelect-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamSelect-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamics-srv:<CamSelect-response> is deprecated: use dynamics-srv:CamSelect-response instead.")))
