...
(cl:defmethod cl:initialize-instance :after ((m <LedAnim-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LedAnim-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamics-srv:<LedAnim-request> is deprecated: use dynamics-srv:LedAnim-request instead.")))
...
(cl:defmethod freq-val ((m <LedAnim-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-srv:freq-val is deprecated.  Use dynamics-srv:freq instead.")
  (freq m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <LedAnim-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-srv:duration-val is deprecated.  Use dynamics-srv:duration instead.")
  (duration m))
...
(cl:defmethod cl:initialize-instance :after ((m <LedAnim-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LedAnim-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamics-srv:<LedAnim-response> is deprecated: use dynamics-srv:LedAnim-response instead.")))
