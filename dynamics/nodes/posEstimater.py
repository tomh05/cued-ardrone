...
'''
This modified dead reckoning script combines the instantaneous values with the particle filter estimation, to smoothly correct it over time.
'''
...
class DeadReckoning:
    def __init__(self):
        ...
        self.rotZoffset = 3.14 # TODO initial value of yaw to allow for offsets
        self.trackPath = Path
        self.path_div = 0
        ...
        # Constant for merging particle filter
        self.k1 = 100.0 #1.0
    ...
    def reset(self,d):
        ...
        self.rotZoffset = 3.14 # TODO sort out a shared convention
        self.trackPath = Path()
        self.path_div = 0
