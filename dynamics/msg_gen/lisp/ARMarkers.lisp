...
(cl:defclass <ARMarkers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector dynamics-msg:ARMarker)
   :initform (cl:make-array 0 :element-type 'dynamics-msg:ARMarker :initial-element (cl:make-instance 'dynamics-msg:ARMarker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ARMarkers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ARMarkers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamics-msg:<ARMarkers> is deprecated: use dynamics-msg:ARMarkers instead.")))
...
(cl:defmethod markers-val ((m <ARMarkers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamics-msg:markers-val is deprecated.  Use dynamics-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ARMarkers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dynamics-msg:ARMarker))
