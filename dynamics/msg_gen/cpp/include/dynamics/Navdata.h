/* Auto-generated by genmsg_cpp for file /home/rujian/fuerte_workspace/cued-ardrone/dynamics/msg/Navdata.msg */
#ifndef DYNAMICS_MESSAGE_NAVDATA_H
#define DYNAMICS_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::dynamics::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamics::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::dynamics::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::dynamics::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::dynamics::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::dynamics::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::dynamics::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::dynamics::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::dynamics::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::dynamics::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "519f4c8d8dd741ec8920b3b2a08e63ba";
  }

  static const char* value(const  ::dynamics::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x519f4c8d8dd741ecULL;
  static const uint64_t static_value2 = 0x8920b3b2a08e63baULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamics::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "dynamics/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::dynamics::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::dynamics::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::dynamics::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::dynamics::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::dynamics::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::dynamics::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // DYNAMICS_MESSAGE_NAVDATA_H
